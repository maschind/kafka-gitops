...
EOF
bin/kafka-console-consumer.sh --bootstrap-server my-cluster-kafka-bootstrap:9094 --topic user1.topic1 --consumer.config=/tmp/consumer.properties --group user3.testing
"
```
